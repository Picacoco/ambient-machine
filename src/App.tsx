...
export default function AmbientMachine() {
  ...
  const fetchRandomRecording = useCallback(async (index: number) => {
    ...
    const fetchPromise = (async () => {
      let searchQuery = "";
      if (type === "field")
        searchQuery = '(subject:"field recording" OR subject:"soundscape" OR subject:"found sound" OR subject:"musique concrete" OR subject:"acoustic ecology") AND mediatype:audio AND -subject:podcast AND -subject:radio AND -subject:talk';
      else if (type === "drone")
        searchQuery = '(subject:"drone music" OR subject:"ambient drone" OR subject:"modular synth" OR subject:"harmonium" OR subject:"pipe organ" OR subject:"resonance" OR subject:"room tone") AND mediatype:audio AND -subject:podcast AND -subject:radio AND -subject:interview AND -subject:host';
      else if (type === "mystery")
        searchQuery = '(subject:"shortwave radio" OR subject:"satellite transmissions" OR subject:"numbers station" OR subject:"space sound" OR subject:"telemetry" OR subject:"vlf recording") AND mediatype:audio AND -subject:podcast AND -subject:talk';
      else
        searchQuery = '(subject:"am radio" OR subject:"radio broadcast" OR subject:"old time radio" OR subject:"cb radio" OR subject:"scanner") AND mediatype:audio';
